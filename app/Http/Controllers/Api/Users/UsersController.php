...
class UsersController extends Controller
{
    ...
    public function update_user_information(Request $request){
        ...
        if($validate->fails()){
            return response()->json(['errors'=>true,'message'=> $validate->errors()],200);
        }
        ...
        if($update){
            return response()->json(['errors'=>false,'message'=> 'infoemation update successfully'],200);
    ...
    public function update_user_password(Request $request){
        ...
        if(Hash::check($request->current_password,$user->password)){
            ...
            if($update){
                return response()->json(['errors'=>false,'message'=> 'password update successfully'],200);
    ...
    public function create_post(){
        ...
        return ['tags' => UsersTagsResource::collection($tags),
           'categories' => UsersCategoriesResource::collection($categories)];
    ...
    public function store_post(Request $request){
        ...
        if($validate->fails()){
            return response()->json(['errors' => true,'messages'  => $validate->errors()],200);
        }
    ...
    public function edit_post($post){
        ...
        $tags = Tag::all();
        $categories = Category::whereStatus(1)->get();
        return ['post' =>new UsersPostsResource($post),'tags' => UsersTagsResource::collection($tags),
            'categories' => UsersCategoriesResource::collection($categories)];
    ...
    public function update_post(Request $request , $post ){
        ...
        if($post){
            ...
            return response()->json(['errors'  => false, 'message'  => 'post update Successfully'],200);
        }
        return response()->json()->with(['errors'   => true,'message'  => ' something was wrong',],200);
    }
    ...
    public function update_comment(Request $request,$id){
        ...
        if($comment){
            ...
            return response()->json(['errors' => false,'message'  => 'comment Updata success'],200);
    ...
    public function delete_comment($id){
        ...
        if($comment){
            $comment->delete();
            Cache::forget('recent_comments');
            return response()->json(['errors' => false,'message' =>'comment delete succesfully' ],200);
