                ...
                <tbody>
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.users.show',$user->id)}}">{{$user->name}}
                                </a>
                            ...
                            <td>
                                ...
                                onclick="if(confirm('Are you sure to delete this user')){document.getElementById('user-delete-{{$user->id}}').submit();}else{return fales;} "
