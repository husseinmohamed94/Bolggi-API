...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create([ 'display_name' => 'Address', 'key' => 'address', 'value' => 'egypt, cairo', 'details' => null, 'type' => 'text', 'section' => 'general', 'ordering' => 9]);
        ...
        Setting::create([ 'display_name' => 'Facebook ID', 'key' => 'facebook_id', 'value' => 'https://www.facebook.com/hess00', 'details' => null, 'type' => 'text', 'section' => 'social_accounts', 'ordering' => 4]);
        Setting::create([ 'display_name' => 'Twitter ID', 'key' => 'twitter_id', 'value' => 'https://twitter.com/hess000', 'details' => null, 'type' => 'text', 'section' => 'social_accounts', 'ordering' => 5]);
        Setting::create([ 'display_name' => 'Instagram ID', 'key' => 'instagram_id', 'value' => 'https://instagram.com/hess00', 'details' => null, 'type' => 'text', 'section' => 'social_accounts', 'ordering' => 6]);
        Setting::create([ 'display_name' => 'Patreon ID', 'key' => 'flickr_id', 'value' => 'https://www.patreon.com/hussein', 'details' => null, 'type' => 'text', 'section' => 'social_accounts', 'ordering' => 7]);
        Setting::create([ 'display_name' => 'Youtube ID', 'key' => 'youtube_id', 'value' => 'https://www.youtube.com/husseinmohamed', 'details' => null, 'type' => 'text', 'section' => 'social_accounts', 'ordering' => 8]);
