...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // POSTS TAGS
        $managePostTags = Permission::create([ 'name' => 'manage_post_tags', 'display_name' => 'tags', 'route' => 'post_tags', 'module' => 'post_tags', 'as' => 'post_categories.index', 'icon' => 'fas fa-tags', 'parent' => $managePosts->id, 'parent_original' => '0', 'appear' => '0', 'ordering' => '16', ]);
